        ...
        <div className="projects">
          ...
          <div className="project-item">
            ...
            <div className="project-info">
              ...
              <p className="project-desc">
                {" "}
                Have you ever wanted to test your Game of Thrones knowledge?
                This is an app made from Vanilla JS that will give you 5 hard
                questions to challenge your skills!
              </p>
              <div className="icon-row">
                <a
          ...
          <div className="project-item">
            ...
            <div className="project-info">
              ...
              <p className="project-desc">
                {" "}
                Web App created to take in a user's location and provide them
                with events to do based on what the weather is that day. Rain =
                Indoor Events, Sun = Outdoor Events.
              </p>
              <div className="icon-row">
                <a
          ...
          <div className="project-item">
            ...
            <div className="project-info">
              ...
              <p className="project-desc">
                ...
                searchable "Employee Directory". Enter a name and only users
                with that same name will pop up!
              </p>
              <div className="icon-row">
                <a
